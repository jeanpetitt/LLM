...
import merging_llm.model.decoder_functions as decoder_functions
import merging_llm.model.encoder_decoder_functions as encoder_decoder_functions
...
class Merges(object):
    ...
    def _load_tokenizer(self):
        if self.token:
            token = self.token
        elif "HF_AUTH_TOKEN" in os.environ:
            token = os.environ["HF_AUTH_TOKEN"]
        else: 
            raise ValueError("you should provide a hf_hub token")
